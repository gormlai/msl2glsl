...
private:
	...
	std::string mapToGLType(const struct VariableDeclaration * vDecl);
	std::string mapToGLType(const struct DeclarationSpecifierList * declSpecList, const BufferDescriptor * bufDesc);
	std::string mapToGLType(const struct DeclarationSpecifier * declSpec, const BufferDescriptor * bufDesc);
	std::string mapToGLType(const struct TypeSpecifier * typeSpec, const BufferDescriptor * bufDesc);
	std::string mapToGLType(const struct Qualifier * qualifier, const BufferDescriptor * bufDesc);
	...
	bool isSamplerGLType(const std::string & glType);
	bool isSimpleGLType(const std::string & glType);
	bool isSimpleGLType(VariableDeclaration * vDecl);
