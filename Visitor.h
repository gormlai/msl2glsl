...
class Visitor
{
 public:
  ...
  virtual void operateOn(struct CastExpression * desc)=0;
  virtual void operateOn(struct CompareExpression * desc)=0;
  virtual void operateOn(struct ConstantExpression * desc)=0;
  virtual void operateOn(struct DeclarationSpecifier * desc)=0;
  virtual void operateOn(struct DeclarationSpecifierList * desc)=0;
  ...
  virtual void operateOn(struct LabeledStatement * node)=0;
  ...
  virtual void operateOn(struct TypeSpecifier * node)=0;
